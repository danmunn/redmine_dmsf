...
The current version of Redmine DMSF is **2.4.8 devel** [![Build Status](https://api.travis-ci.com/danmunn/redmine_dmsf.png)](https://travis-ci.com/danmunn/redmine_dmsf)

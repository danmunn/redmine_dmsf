...
class DmsfLinksTest < RedmineDmsf::Test::UnitTest
  ...
  def test_validate_name_length
    ...
    assert_not @folder_link.save, "Folder link #{@folder_link.name} should have not been saved"
  ...
  def test_validate_external_url_length
    ...
    assert_not @file_link.save, "External URL link #{@file_link.name} should have not been saved"
  ...
  def test_find_link_by_file_name
    file_link = DmsfLink.find_link_by_file_name(@file_link.project, @file_link.dmsf_folder, @file_link.target_file.name)
  ...
  def test_restore_file_link
    ...
    assert_not @file_link.deleted?, "File link hasn't been restored"
  end

  def test_delete_folder_link
    assert @folder_link.delete(commit: false), @folder_link.errors.full_messages.to_sentence
  ...
  def test_restore_folder_link
    ...
    assert_not @folder_link.deleted?, "Folder link hasn't been restored"
  end

  def test_destroy_file_link
    assert @file_link.delete(commit: true), @file_link.errors.full_messages.to_sentence
    assert_nil DmsfLink.find_by(id: @file_link.id)
  end

  def test_destroy_folder_link
    assert @folder_link.delete(commit: true), @folder_link.errors.full_messages.to_sentence
